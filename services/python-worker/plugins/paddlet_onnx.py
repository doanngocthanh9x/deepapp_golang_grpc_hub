...
# Import from existing modules (relative to plugins/)
from nets import nn
...
class paddlet_onnx:
    ...
    def __init__(self, weights_dir: str = 'weights'):
        ...
        # Initialize models
        print(f"Initializing paddlet_onnx with weights from '{weights_dir}'...: {detection_path}")
        ...
        print(f"✓ paddlet_onnx initialized successfully!")
...
if __name__ == '__main__':
    ...
    processor = paddlet_onnx('weights')
    
    print("\n" + "="*60)
    print("DEMO: paddlet_onnx")
    print("="*60)
